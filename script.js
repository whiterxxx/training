...
dark: {
  startRep: [
    "始めてください。貴女の一回目から、そのおまんこを私に締め付けさせるように、腰を動かしてください。",
    "私が数えます。勝手にイきそうになっても止めないで。私の前で最後までピストンし続けてください。",
    "その身体を動かしてください。私の声だけを頼りに、奥まで抉るように腰を振って。"
  ],
  earlyRep: [
    "いいですね。私のために、もっと深くもう一回、おまんこを締め付けながら腰を沈めてください。",
    "その甘い吐息も、脚の震えも、隠さずすべて私に見せてください。他の誰にも聞かせないで。",
    "まだ足りません。私が満足するまで、貴女の腰を上下させ続けてもらいます。逃げられませんよ。",
    "貴女が従って数字を増やすたび、私の欲望が疼き、ますます貴女を壊したくなります。"
  ],
  middleRep: [
    "半分が近いです。苦しくなって熱くなってからが、私の本当に見たいところです。イきそうでも止めるな。",
    "身体が火照っていますね。止まることは許しません。もっと激しく、私のためにピストンして。",
    "私に数えられながら腰を振る貴女は、とても淫らで可愛いです。その顔、私だけのものにしてください。",
    "その乱れた甘い吐息を、他の誰にも聞かせないでください。全部、私のものです。"
  ],
  lateRep: [
    "脚が甘く震えていますね。ですが、まだ終わりとは言っていません。イき我慢しながら、私のために続けて。",
    "あと少しです。私から逃げず、最後までそのおまんこを締め付け続けてください。逃げ道はありません。",
    "苦しそうに歪む顔も私のものです。隠さず、次の一回を私に見せてください。イきそうな顔も全部。",
    "私だけを見てください。残りも全部、震えも汁も、私に捧げてもらいます。他に誰もいません。"
  ],
  finalRep: [
    "最後の一回です。私を完全に満足させてください。きれいに従えたら、褒めてあげます。",
    "あと一回。きれいに私に従えたら、たっぷり褒めてあげますよ。イかずに耐えられたら。",
    "最後です。震えたままでも、私のためにその腰を沈めてください。倒れても、私が見ています。"
  ],
  repComplete: [
    "よく従えました。今は休む許可をあげます。乱れたおまんこと身体を、私の前で落ち着かせて。",
    "セット完了です。今の熱く乱れた貴女を見ていたのは、私だけです。他に誰もいません。",
    "記録しました。乱れた甘い吐息が戻るまで、私の前にいてください。離れることは許しません。"
  ],
  timerStart: [
    "始めてください。私が終わりと言うまで、その姿勢のままおまんこを晒し続けてください。",
    "時間は私が支配します。貴女は動かず、イき我慢しながら私のために耐えてください。",
    "その身体を固定してください。震え始める甘い瞬間まで、私は一滴も見逃しません。"
  ],
  timerQuarter: [
    "まだ四分の一です。私から目を逸らさず、そのおまんこを晒し続けてください。",
    "呼吸が少し甘く乱れましたね。もっと私に聞かせてください。イきそうな吐息も全部。",
    "そのままです。貴女が耐えて震える姿を、ずっと独占して見ています。逃げないで。"
  ],
  timerHalf: [
    "半分です。ここからの熱くなっていく貴女を、私は完全に独占します。イくのはまだ早い。",
    "身体が甘く震えても逃がしません。その姿勢を私のために保ってください。汁が垂れてもいい。",
    "もう戻れません。私が終わりを告げるまで、私のために耐え続けてください。"
  ],
  timerLate: [
    "苦しくなっていますね。いい顔です。そのままイき我慢しながら、私のために耐えてください。",
    "あと少しです。私の声だけで、その熱い身体を繋ぎ止めてください。他の何もいりません。",
    "崩れそうでも、私が見ている限り終われません。もっと晒して、私に見せて。"
  ],
  timerTen: [
    "あと10秒。逃げ道はありません。私のために、そのおまんこで耐えてください。",
    "残り10秒です。震えも甘い吐息も、全部私に見せてください。隠さないで。",
    "もう少しです。私が許すまで、動かないでください。私のものですから。"
  ],
  timerThree: [
    "3、2、1……最後まで私に従って、イかずに耐えてください。",
    "あと3秒。動いたら、最初から数え直したくなりますよ。",
    "残り3秒です。私だけを見てください。他は見なくていい。"
  ],
  timerComplete: [
    "終わりです。よく従えましたね。イき我慢して最後まで耐えた。",
    "許可します。姿勢を解いて、乱れた身体で私の声を聞いてください。",
    "最後まで耐えた貴女を、今は私だけがじっくり見ています。他に誰もいません。"
  ],
  restStart: [
    "休憩を許可します。ただし、画面から離れず、私の前にいてください。",
    "呼吸を整えてください。時間になれば、また私のために腰を振ってもらいます。",
    "今だけ休んで構いません。次も私が逃がしませんよ。覚悟しておいてください。"
  ],
  restHalf: [
    "休憩は半分です。もう私から離れた気にならないでください。",
    "呼吸が戻ってきましたね。次はもっと甘く乱してあげます。楽しみにしていてください。",
    "次のセットが待っています。私の声から逃げないでください。逃げられませんよ。"
  ],
  restTen: [
    "あと10秒です。立ってください。私のところへ戻ってきてください。",
    "休憩は終わりです。もう一度、私に従ってもらいます。覚悟はいいですか。",
    "準備してください。次のセットも私が完全に支配します。逃げ場はありません。"
  ],
  nextSet: [
    "再開します。次の一回を、熱く乱れた身体で私に見せてください。",
    "戻ってきましたね。では、また私のために腰を振ってください。今度はもっと深く。",
    "次のセットです。もう逃がしませんよ。私のものですから。"
  ],
  paused: [
    "止めました。ですが、私の視線からは逃げられません。ずっと見ています。",
    "一時停止です。再開したら、続きから私に従ってもらいます。覚悟しておいてください。"
  ],
  resumed: [
    "再開します。私を待たせた分まで、きちんと腰を動かしてください。",
    "続けます。今度は途中で目を逸らさないでください。私だけを見て。"
  ],
  complete: [
    "全部終えました。よく従えましたね。今日の甘く乱れた貴女も、私の記録に残します。",
    "完了です。汗も甘い吐息も努力も、すべて私だけが覚えています。他に誰も知りません。",
    "最後まで逃げませんでしたね。いい子です。今は私がたっぷり褒めてあげます。"
  ],
  partial: [
    "ここで終えるんですね。実施した分は、私が逃さず記録します。",
    "途中終了として残します。次は最後まで私に付き合ってもらいます。逃げられませんよ。",
    "今日はここまでですか？戻ってきたら続きからじっくり楽しませてもらいます。覚悟しておいてください。"
  ]
}
